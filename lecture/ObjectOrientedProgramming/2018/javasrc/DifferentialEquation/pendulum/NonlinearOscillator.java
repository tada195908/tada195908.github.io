...
public class NonlinearOscillator {
    ...
    public NonlinearOscillator(double x, double v, double k, double lambda) {
        this.x = x;
        this.v = v;
        this.k = k;
        this.lambda = lambda;
        equation = (double xx, double[] y) -> {
            ...
            dy[0] = y[1];
            dy[1] = -k * y[0] - lambda * Math.pow(y[0], 3.);
            return dy;
        };
    }
    ...
    public static void main(String[] args) throws IOException {
        NonlinearOscillator sys = new NonlinearOscillator(0., 1., 1., 5.);
        double t = 50.;
        int nstep = 10000;
